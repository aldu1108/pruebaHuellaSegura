...
interface BottomNavigationSearchProps {
  onNavigate: (page: string) => void;
}

export function BottomNavigationSearch({ onNavigate }: BottomNavigationSearchProps) {
  return (
    <nav className="fixed bottom-0 left-0 right-0 h-16 px-4 flex items-center justify-around" style={{ backgroundColor: '#EE9444' }}>
      ...
      <button className="p-3 rounded-lg transition-colors bg-white">
        <Search size={24} style={{ color: '#E55826' }} />
      </button>
