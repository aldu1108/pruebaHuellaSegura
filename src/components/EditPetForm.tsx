...
import { X, Save, Camera, Calendar, Weight } from 'lucide-react';
...
export function EditPetForm({ isOpen, pet, onClose, onSave }: EditPetFormProps) {
  ...
  const handlePhotoChange = () => {
    // Simulación de cambio de foto - en una app real esto abriría la galería
    const newImages = [
      'https://images.unsplash.com/photo-1518717758536-85ae29035b6d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1080',
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-lg max-w-md w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex justify-between items-center p-4 border-b">
          <h2 className="text-xl font-bold text-[#3D291D]">Editar Perfil de {pet.name}</h2>
          <button 
            onClick={onClose}
